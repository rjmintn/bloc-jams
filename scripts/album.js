...
window.onload = function() {
    ...
    songListContainer.addEventListener('click',function(event) {
        ...
        var findParentByClassName = function(element, targetClass) {
            ...
            if (element){
                var currentParent = element.parentElement;
                while (!currentParent.querySelector('.'+targetClass)){
                    currentParent = currentParent.parentElement;
                }
                return currentParent;
            }
...
// My Attempt own my own...

/*var mouseClick = "";
var mc = "";

function findParentByClassName(callback) {
            mouseClick = mouseClick.parentElement;
            callback(mouseClick);
        };
...
window.onload = function() {
    ...
    songListContainer.addEventListener('click',function(event) {
        ...
        while (!mouseClick.querySelector('.song-item-number')){
            findParentByClassName(function(mc){});
        }
        mouseClick.querySelector('.song-item-number').innerHTML = pauseButtonTemplate;
    });    
